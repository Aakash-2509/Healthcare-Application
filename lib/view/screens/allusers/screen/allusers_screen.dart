...
class _AllusersScreenState extends ConsumerState<AllusersScreen> {
  ...
  void _refreshUsers() {
    ref.refresh(allUsersProvider(Tuple2(currentPage, selectedPageSize)));
  }
  ...
  void _deleteUser(String userId) async {
    ...
    if (confirmed != null && confirmed) {
      bool success = await ref.read(apiProvider).deleteUser(userId);
      if (success) {
        Fluttertoast.showToast(msg: Appstring.userDeletedSuccessfully);
        _refreshUsers();
      } else {
        Fluttertoast.showToast(msg: Appstring.userDeleteUnsuccessfully);
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    final userData =
        ref.watch(allUsersProvider(Tuple2(currentPage, selectedPageSize)));
      ...
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          return RefreshIndicator(
            ...
            child: userData.when(
              data: (users) {
                final filteredUsers = users.userData
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            TextButton(
                              onPressed:
                                  users.userData.length == selectedPageSize
                                      ? _goToNextPage
                                      : null,
                              child: Text(
